  ...
  <div className="w-full bg-[#5B4DDB] rounded-[40px] p-8 sm:p-12 text-white relative overflow-hidden border-[4px] border-[#4539a5] shadow-[0_10px_0_#3730a3] mb-12 group">
    ...
    <div className="relative z-10 flex items-center justify-between">
      <div className="max-w-[65%]">
        <h1 className="text-5xl sm:text-7xl font-black tracking-tighter mb-3 uppercase italic leading-none drop-shadow-[0_4px_0_rgba(0,0,0,0.1)]">
          QUEST
        </h1>
        <p className="text-white font-bold text-sm sm:text-2xl leading-tight uppercase tracking-tight opacity-90">
          Finish tasks and earn rewards
        </p>
      </div>
      <div className="relative w-[100%] sm:w-[100%] flex justify-end pointer-events-none z-10">
        <img
          src={questMascot}
          alt="Quest Mascot"
...
const QuestCard: React.FC<QuestCardProps> = ({
  ...
  const shadowColor = isDaily
    ? "shadow-[0_8px_0_#3730a3]"
    : "shadow-[0_8px_0_#ca652d]";
    ...
    <div className="bg-white rounded-[40px] p-8 sm:p-10 border-[4px] border-slate-100 shadow-[0_10px_0_#f1f5f9] group hover:translate-y-1 hover:shadow-none transition-all duration-200 cursor-pointer">
      <div className="flex justify-between items-start gap-6 mb-10">
        <div className="flex-1">
          <h2
            className={`text-2xl font-black uppercase tracking-tight mb-2 ${isDaily ? "text-[#5B4DDB]" : "text-[#FF8A4C]"}`}
          >
            {title}
          </h2>
        ...
        <div
          className={`w-24 h-24 rounded-[32px] flex items-center justify-center shrink-0 border-[4px] ${borderColor} ${colorClass} ${shadowColor} relative group-hover:rotate-6 transition-all duration-300`}
        >
      ...
      <div className="space-y-4">
        <div className="flex justify-between items-end px-2">
          ...
          <div
            className={`px-4 py-1.5 rounded-full border-[3px] ${isDaily ? "bg-[#F1EEFF] border-[#5B4DDB]/10 text-[#5B4DDB]" : "bg-[#FFF9E6] border-amber-100 text-amber-600"} font-black text-sm tabular-nums shadow-sm`}
          >
    ...
    <div className="w-full max-w-4xl mx-auto pb-32 px-4 font-sans bg-[#F8F9FF] min-h-screen pt-8">
      ...
      <div className="mt-16 flex justify-center">
        <div className="flex items-center gap-4 bg-white px-8 py-4 rounded-full border-[3px] border-slate-100 shadow-[0_4px_0_#f1f5f9]">
          ...
          <span className="text-[#7B7F97] font-black text-[10px] uppercase tracking-[0.3em]">
            Discovery more missions
          </span>
        </div>
      </div>
