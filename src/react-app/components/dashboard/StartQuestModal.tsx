  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
      ...
      <div className="relative z-10 w-full max-w-[440px] max-h-[90vh] overflow-y-auto no-scrollbar bg-white rounded-[40px] border-[4px] border-slate-100 shadow-[0_12px_0_rgba(0,0,0,0.1)] p-8 sm:p-10 animate-in fade-in zoom-in duration-300 text-center">
        <div className="w-24 h-24 sm:w-28 sm:h-28 bg-[#F1EEFF] rounded-[32px] flex items-center justify-center text-5xl sm:text-6xl mx-auto mb-8 border-[3px] border-white shadow-inner">
           ⚔️
        </div>
        
        <h3 className="text-3xl sm:text-4xl font-black text-[#111827] uppercase tracking-tighter italic mb-6">
          Begin Quest?
        </h3>
        ...
        <div className="bg-slate-50 rounded-[32px] p-6 sm:p-8 mb-10 border-[3px] border-slate-100 text-left relative overflow-hidden">
           ...
           <p className="text-[10px] font-black text-[#7B7F97] uppercase tracking-[0.2em] mb-3 opacity-60">Objective</p>
           <h4 className="text-2xl font-black text-[#5B4DDB] uppercase tracking-tight leading-none mb-6">{task.title}</h4>
           
           {task.description && (
             <div className="mb-8">
                <p className="text-[10px] font-black text-[#7B7F97] uppercase tracking-[0.2em] mb-3 opacity-60">Mission Intel</p>
           ...
           <div className="flex items-center gap-6">
              <div className="flex items-center gap-2.5">
                 ...
                 <span className="font-black text-sm text-[#111827] uppercase tracking-tight">{task.timeEstimation}m</span>
              </div>
              <div className="flex items-center gap-2.5">
                 ...
                 <span className="font-black text-sm text-[#111827] uppercase tracking-tight">+{task.timeEstimation * 2} XP</span>
              </div>
           </div>
        </div>
